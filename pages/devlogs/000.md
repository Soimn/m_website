...
AFAIK this is kind of how Python handles it, which I find reasonable. This would allow not only regular old operator overloading, but also defining overloads for a range of types.
